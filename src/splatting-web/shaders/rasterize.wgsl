...
var<workgroup> start_offset_shared_2: i32;
var<workgroup> end_offset_shared_2: i32;
...
fn main(
  ...
  // for (var off_idx = 0; off_idx < num_depth_tiles; off_idx++) {
    ...
    // if (input_count < shared_memory_size) {
      ...
      //   let idx = thread_idx * inputs_per_thread + i;
    ...
    for (var idx = start_offset; idx < end_offset; idx++) {
    // for (var idx = start_offset_local[off_idx_test]; idx < end_offset_local[off_idx_test]; idx++) {
